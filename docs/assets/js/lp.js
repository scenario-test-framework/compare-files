const translations = {
  ja: {
    ...
    formatsKicker: "STRUCTURED OR VISUAL", formatsTitle: "<span class=\"nowrap\">いつものファイルを、</span><br><span class=\"nowrap\"><em>ひとつの流儀</em>で比較。</span>", formatsBody: "レイアウト定義により、比較キー・比較条件・無視する項目をファイル形式ごとに管理できます。", layoutLink: "比較レイアウト仕様を見る <span aria-hidden=\"true\">→</span>",
