const translations = {
  ja: {
    ...
    startKicker: "START IN ONE COMMAND", startTitle: "まずはサンプルで、<br><em>差分を出してみる。</em>", startBody: "Dockerベースの実行環境、設定、全形式のサンプルをまとめてセットアップします。", installLabel: "インストール方法", copy: "コピー", copied: "コピー済み", copyFailed: "コピーできませんでした", readDocs: "READMEで詳しく見る <span aria-hidden=\"true\">→</span>", binaryDownload: "バイナリを取得", reportLabel: "比較レポート例", finalEyebrow: "STOP EYEBALLING DIFFS.", finalTitle: "その差分、<em>自動化できます。</em>", finalCta: "compare-files を試す <span aria-hidden=\"true\">→</span>", footerText: "Apache-2.0 · 再現可能な比較のためのCLI。", footerGitHub: "GitHub", footerIssues: "Issues"
  },
  en: {
